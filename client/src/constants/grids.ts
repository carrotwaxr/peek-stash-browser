...
export const STANDARD_GRID_DENSITIES = {
  small:
    "card-grid-responsive density-small grid gap-4 grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6 3xl:grid-cols-8 4xl:grid-cols-10 5xl:grid-cols-14",
  medium:
    "card-grid-responsive density-medium grid gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 3xl:grid-cols-6 4xl:grid-cols-8 5xl:grid-cols-12",
  large:
    "card-grid-responsive density-large grid gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-3 3xl:grid-cols-4 4xl:grid-cols-5 5xl:grid-cols-8",
};

/** SCENE GRID DENSITY LEVELS */
export const SCENE_GRID_DENSITIES = {
  small:
    "card-grid-responsive density-small grid gap-4 grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6 3xl:grid-cols-7 4xl:grid-cols-9 5xl:grid-cols-12",
  medium:
    "card-grid-responsive density-medium grid gap-4 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 3xl:grid-cols-6 4xl:grid-cols-7 5xl:grid-cols-10",
  large:
...
export const getGridClasses = (gridType: string, density = "medium") => {
  const densities: Record<string, string> =
    gridType === "scene" ? SCENE_GRID_DENSITIES : STANDARD_GRID_DENSITIES;
