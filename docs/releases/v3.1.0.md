...
- **Activity feedback** - Shows what's driving your recommendations
...
Parameterized queries in SceneTagInheritanceService:

- Replaced `$executeRawUnsafe` with parameterized `$executeRaw`
...
- Cross-page lightbox navigation not yet available on standalone Images page (works in Gallery view)
...
- UI end-to-end testing infrastructure
- Rate limiting on security-sensitive endpoints
- Audit logging for password changes
- Cross-page lightbox on Images page
